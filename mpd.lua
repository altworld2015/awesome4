...
desktop_wibox30:geometry({ x = 792, y = 568, width = 10, height = 32 })
...
desktop_wibox18:geometry({ x = 803, y = 568, width = 32, height = 32 })
desktop_wibox18:set_widget(prev_icon)

local desktop_wibox31 = wibox({ type = "desktop", visible = true, bg = "#00000000" })
desktop_wibox31:geometry({ x = 836, y = 568, width = 10, height = 32 })
...
desktop_wibox15:geometry({ x = 847, y = 568, width = 32, height = 32 })
desktop_wibox15:set_widget(stop_icon)

local desktop_wibox32 = wibox({ type = "desktop", visible = true, bg = "#00000000" })
desktop_wibox32:geometry({ x = 880, y = 568, width = 10, height = 32 })
...
desktop_wibox14:geometry({ x = 891, y = 568, width = 32, height = 32 })
desktop_wibox14:set_widget(next_icon)

local desktop_wibox33 = wibox({ type = "desktop", visible = true, bg = "#00000000" })
desktop_wibox33:geometry({ x = 924, y = 568, width = 10, height = 32 })
...
desktop_wibox19:geometry({ x = 935, y = 568, width = 58, height = 32 })
desktop_wibox19:set_widget(volume_master)
--------

local desktop_wibox34 = wibox({ type = "desktop", visible = true, bg = "#00000000" })
desktop_wibox34:geometry({ x = 994, y = 568, width = 10, height = 32 })
